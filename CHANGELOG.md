...
## [v0.14.0] - 2022-07-24
### Добавлено
- Зависимость springdoc-openapi-ui
- Аннотации springdoc в контроллеры
- Класс конфигурации springdoc
- Добавлен метод подсчета учетных записей по электронной почты
- Добавлен класс поиска пользователя по электронной почте
- Добавлен метод поиска пользователя по электронной почте в интерфейс UserRepositories

### Изменено
- Включены проверки при создании сущности User
- Исправлен enum AlreadyExists
- обновлен README.md

### Удален
- Удален файл grade.db из проекта
...
## [v0.9.0] - 2022-06-22
### Добавлено
- создан фейковый репозиторий для класса User
...
- изменен класс ru.kiryanovid.application.dto.task.TaskRequestDto
  добавлены геттеры в перечисление ru.kiryanovid.domain.entity.task.Status
...
### Изменено
- Добавлены поля в классах File и Comment. Классы File, Comment, CommentDto, CommentRequestDto, FileDto перенесены в соответствующие пакеты
